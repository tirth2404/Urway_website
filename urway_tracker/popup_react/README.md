...
Notes:
- The React app fetches encrypted activities from `http://localhost:5000/activities?userEmail=...` and attempts to decrypt them using the registration timestamp (via `CryptoUtils`).
